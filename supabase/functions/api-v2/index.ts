...
const SYNC_COLS = `id, name, name_fr, name_en, name_ar, lat, lng, zone, category, history_context, description_short, local_anecdote, local_anecdote_fr, local_anecdote_en, fun_fact_fr, fun_fact_en, riddle_easy, riddle_medium, riddle_hard, crowd_level, accessibility_notes, photo_tip, is_photo_spot, instagram_spot, must_try, must_see_details, must_visit_nearby, poi_quality_score, enrichment_status, history_context_en, riddle_easy_en, wikipedia_summary_en, story_fr, story_en`;
