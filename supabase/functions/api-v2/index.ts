...
const POI_DETAIL_COLS = `id, name, name_fr, name_en, name_ar, lat, lng, category, category_ai, category_google, subcategory, status, is_active, is_start_hub, hub_theme, rating, reviews_count, poi_quality_score, address, description_short, history_context, local_anecdote, local_anecdote_fr, local_anecdote_en, fun_fact_fr, fun_fact_en, instagram_spot, instagram_score, instagram_tips, photo_tip, is_photo_spot, photo_spot_score, best_time_visit, crowd_level, opening_hours, price_info, accessibility_notes, street_food_spot, street_food_details, must_try, must_see_details, must_visit_nearby, audience_tags, route_tags, district, zone, radius_m, riddle_easy, riddle_medium, riddle_hard, challenge, tourist_interest, best_client_photo_url, nearby_pois_ids, wikidata_id, wikipedia_summary, website_url, phone, audio_url_fr, audio_url_en, audio_url_ar, anecdote_audio_url_fr, anecdote_audio_url_en, created_at, updated_at`;

const SYNC_COLS = `id, name, name_fr, name_en, name_ar, lat, lng, zone, category, real_category, subcategory, status, is_active, is_start_hub, hub_theme, rating, reviews_count, address, description_short, history_context, history_context_en, wikipedia_summary, wikipedia_summary_en, local_anecdote, local_anecdote_fr, local_anecdote_en, fun_fact_fr, fun_fact_en, riddle_easy, riddle_easy_en, riddle_medium, riddle_hard, crowd_level, accessibility_notes, accessibility_notes_en, photo_tip, photo_tip_en, is_photo_spot, instagram_spot, must_try, must_try_en, must_see_details, must_see_details_en, must_visit_nearby, must_visit_nearby_en, tourist_tips, tourist_tips_en, price_info, price_info_en, best_time_visit, best_time_visit_en, street_food_details, street_food_details_en, poi_quality_score, enrichment_status, story_fr, story_en, audio_url_fr, audio_url_en, audio_url_ar, anecdote_audio_url_fr, anecdote_audio_url_en, opening_hours, best_client_photo_url, metadata`;
